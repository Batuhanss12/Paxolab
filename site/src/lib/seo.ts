...
export const SPOKE_PARENT: Record<string, { tr: string; en: string; trName: string; enName: string }> = {
  ...
  "grapxor-vektor-motoru-nasil-calisir": { tr: "ai-ambalaj-tasarimi", en: "what-is-ai-packaging-design", trName: "AI ambalaj tasarımı", enName: "AI packaging design" },
  ...
  "how-grapxor-vector-engine-works": { tr: "ai-ambalaj-tasarimi", en: "what-is-ai-packaging-design", trName: "AI ambalaj tasarımı", enName: "AI packaging design" },
