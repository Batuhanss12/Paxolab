...
serviceName: "Packaging preflight checklist",
  ...
  pricing: {
    meta: {
      title: "Grapxor plans and pricing",
      description:
        "Monthly Grapxor plans: Başlangıç 699 TL, Plus 1,799 TL, Pro 3,699 TL, Studio 6,999 TL, Agency 39,999 TL. First design 117 credits, revision 3 credits.",
    },
    title: "Pricing",
    chooseTitle: "Choose your plan",
    lead: "Billed monthly. First design is 117 credits; revisions and changes are a flat 3 credits.",
    note: "Prices in TRY, excluding VAT. Payment completes in the studio.",
    periodMonthly: "Monthly",
    periodYearly: "Yearly",
    periodYearlySoon: "Soon",
    perMonth: "/ mo",
    perCredit: "TL / credit",
    unlimitedLabel: "Unlimited design",
    includedTitle: "Included",
    firstDesignHint: "first designs",
    planCards: [
      {
        id: "baslangic",
        label: "Başlangıç",
        features: [
          "500 credits / month",
          "About 4 first designs",
          "Revisions and changes at 3 credits",
          "Box, label, dieline",
          "Print-ready vector",
        ],
        cta: "Choose Başlangıç",
      },
      {
        id: "plus",
        label: "Plus",
        ...
        features: [
          "1,500 credits / month",
          "About 12 first designs",
          "Revisions and changes at 3 credits",
          "Partial credit rollover",
          "3 team seats",
        ],
        cta: "Choose Plus",
      },
      ...
      },
      {
        ...
        features: [
          "7,500 credits / month",
          "About 64 first designs",
          "Revisions and changes at 3 credits",
          "Full credit rollover",
          "Heavy production months",
        ],
        cta: "Choose Studio",
      },
      {
    ...
    usage: [
      { action: "First design", cost: "117 credits" },
      { action: "Revision and changes", cost: "3 credits" },
      { action: "Final export", cost: "1 credit" },
    ],
    usageTitle: "Credit usage",
    creditsUnit: "credits",
    studioCta: "Choose a plan in studio",
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "In a signed-in session the first design is 117 credits; revisions and changes are a flat 3 credits. Monthly plans (Başlangıç–Agency) and packs share the same catalog; payment completes in the studio.",
      },
      {
