...
assert(boxBack.includes('COMPOSITION') || boxBack.includes('İÇERİK'), 'box back missing legal stack')
assert(!wrapFace.includes('COMPOSITION') && !wrapFace.includes('FLAMMABLE') && !wrapFace.includes('YANICI · UYARI'), 'wrap face has box legal')
assert(!flatFace.includes('COMPOSITION') && !flatFace.includes('İÇERİK / SPEC'), 'flat face has box legal')
