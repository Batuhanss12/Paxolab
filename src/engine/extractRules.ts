...
export const SECTOR_NOUN_RE =
  /kozmetik|gıda|içecek|sağlık|takviye|bebek|elektronik|parfüm|parfum|perfume|krem|serum|yağ|temizlik|food|beverage|health|baby|cosmetic|tech/i

/** Generic product name tokens — not valid SKU names. */
export const GENERIC_PRODUCT_RE =
  /^(parfüm|parfum|perfume|krem|cream|serum|içecek|beverage|takviye|supplement|bebek|baby|etiket|kutu|kutusu|ambalaj|kozmetik|gıda|sağlık|şişe|wrap|label)$/i

/** Stop words for brand/product name extraction. */
export const NAME_STOP_RE =
  /^(için|bir|ve|ile|adı|adın|adını|marka|brand|ürün|product|kozmetik|kutusu|kutu|ambalaj|etiket|gıda|elektronik|luxury|modern|minimal|eco|playful|classic|daha|premium|lüks|parfüm|perfume|krem|serum)$/i
