...
export const LABEL_DNA: Record<LabelArchetype, ArchetypeDna> = {
  'card-on-art': {
    ...
    sectors: { cream: 1, serum: 0.8, baby: 0.9, cleaning: 0.7, health: 0.5, food: 0.3, beverage: 0.3, generic: 0.5 },
  ...
  'line-scene': {
    ...
    typePairing: 'sans-light/sans-heavy',
    temperaments: ['clean-clinical'],
    frame: 'rounded-card',
    lockup: 'stacked-center',
    sectors: { health: 1, baby: 0.9, cream: 0.8, serum: 0.8, cleaning: 0.6, generic: 0.5 },
...
export const BOX_DNA: Record<BoxArchetype, ArchetypeDna> = {
  ...
  'botanical-card': {
    ...
    frame: 'rounded-card',
    lockup: 'top-right-pill',
    sectors: { cream: 1, serum: 0.8, baby: 0.9, cleaning: 0.8, health: 0.5, food: 0.4, generic: 0.5 },
