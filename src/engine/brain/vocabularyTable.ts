/**
 * Vocabulary table — sector×subProduct data rows.
 * Extracted from SectorVisualVocabulary.ts to isolate the data table from lookup/rules logic.
 */
...
export const VOCAB: VocabularyRow[] = [
  // ── COSMETICS / PERFUME ──
  {
    ...
    forbiddenHeroes: ['harvest', 'botanical', 'seal'],
  ...
  // ── SKINCARE ──
  {
    ...
    heroFamilies: ['oval', 'botanical', 'emblem', 'monstera', 'palm', 'organic-wave', 'zebra'],
    ...
    forbiddenHeroes: ['harvest', 'tech', 'seal'],
  ...
  // ── FOOD ──
  {
    ...
    forbiddenHeroes: ['crest', 'tech', 'seal'],
