...
import type { StudioDirectionOffer, StudioFamily, StudioSurface } from '../engine/studio/types'
...
export function DirectionChoice({ offer, surface, brandName, productName, busy, onPick, onKeep }: DirectionChoiceProps) {
